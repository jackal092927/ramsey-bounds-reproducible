...
September 3 continuation: the broad Pro response is [collected and independently dispositioned](collaboration/2026-09-02/PRO_REVIEW_DISPOSITION_2026-09-03.md). The strongest current candidate is [all-chain concentration from finite zero-weight certificates](collaboration/2026-09-02/FINITE_CERTIFICATE_CONCENTRATION.md), with linear dependence on the logical gap. The complete fixed real-gate palette and end-to-end transfer theorem have since passed bounded reviews. The [source-complexity review](collaboration/2026-09-02/PRO_SOURCE_COMPLEXITY_DISPOSITION_2026-09-03.md) blocks unrestricted SDQC1 hardness. A later [eight-label source lemma](collaboration/2026-09-02/NORMALIZED_BQP1_SOURCE_GATE.md) now has a completed [bounded Pro audit and independent disposition](collaboration/2026-09-02/PRO_BQP1_SOURCE_DISPOSITION_2026-09-03.md), supporting a limited weighted, gate-dependent BQP1 hardness route under the geometric hypotheses. The [targeted novelty-collision audit](collaboration/2026-09-02/NOVELTY_COLLISION_AUDIT_2026-09-03.md) and completed [Pro source review](collaboration/2026-09-02/PRO_NOVELTY_DISPOSITION_2026-09-03.md) rate the current value MEDIUM, conditional: exact multiplicity and the normalized target are prior, King--Kohler contains much of the arbitrary-chain machinery, and Gyurik et al. already states a particular whole-kernel gap. The publishable delta is the corrected finite-certificate all-chain transfer theorem and its restricted normalized-rank application. The primary theorem uses fixed \(\beta_d(X_{\rm in})=8\); growing denominator is only tensor replication. A modular [19-page manuscript v0](collaboration/2026-09-02/manuscript_v0/README.md) now records the weighted theorem, quotient naturality, gate-dependent hardness, sourced unweighted corollary, and explicit limits.
