...
| Rational projector palette and tensor guards | REMAINING_ACTIVE_ATOM_CERTIFICATES.md, ACTIVE_HADAMARD_ORBIT.md, SELECTED_CYCLE_GUARD_CLOSURE.md | Source-pinned exact certificates now cover every listed base atom; alternative selected-cycle guard closure accepted conditionally. End-to-end integration and priority remain open |
