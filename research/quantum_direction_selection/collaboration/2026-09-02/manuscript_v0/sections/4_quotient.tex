...
=\dim K_{A_j}.
\]
Harmonic representatives may rotate between filtration levels; the exact
statement concerns the algebraic homology maps.
...
\end{equation}
This identity is the bridge from exact logical perfect-space fractions to normalized persistence.
