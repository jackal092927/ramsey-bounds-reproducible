...
- [八标签 BQP1 有界审查包](PRO_BQP1_SOURCE_PACKET_2026-09-03.md)：仅核对 acceptance operator、clean/mixed interface、\(G_2\) 精确实现、denominator 与 gate-dependent hardness composition；不做 gadget 或 novelty 审查。
