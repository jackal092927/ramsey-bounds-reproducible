...
twelve release payloads.  It compares the independent sequential schemas with
all six actual counter blocks, reconstructs all six formulas, replays all six
