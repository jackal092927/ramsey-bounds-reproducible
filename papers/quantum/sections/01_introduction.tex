...
Ramsey number, construct an avoidance colouring, or prove a new interval for
$R(3,18)$.  It gives a near-quadratic query improvement over the standard
$O(N)$ constructive recursion, but no matching lower bound against every
randomized classical algorithm is presently known.
...
The rest of this part defines the oracle model and capped sampler, proves the
