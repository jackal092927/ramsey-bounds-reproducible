...
write their weighted algebraic extension explicitly; (2.41) is the frozen
scalar baseline.  The nonuniform estimate is proved locally and is not
attributed verbatim to HMS.\\
